...
@RestController // Deﬁne que a Classe é do tipo RestController que receberá requisições composta
				// por :URL,Verbo Método HTTP, Body - corpo com dados ou não
@RequestMapping("/postagens") // Essa anotação indica que as requisições HTTP direcionadas para /postagens
								// serão tratadas pelo método ou classe que ela anota.
